...
const FloatingAiButton: React.FC<FloatingAiButtonProps> = ({ onClick, onLongPress, constraintsRef, isListening }) => {
    ...
    return (
        ...
        >
             <div className={`w-full h-full rounded-full bg-primary text-white flex items-center justify-center shadow-lg transform transition-transform active:scale-95 ${isListening ? 'animate-orb-glow-listening' : 'animate-orb-glow'}`}>
