    ...
    >
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 px-2 sm:px-0">
            ...
            <div className="flex items-center gap-2 w-full md:w-auto">
                ...
                <button onClick={onOpenMoveModal} className="p-2 rounded-xl bg-surface dark:bg-dark-surface border-2 border-border-color dark:border-dark-border-color text-slate-400 hover:text-primary transition-all shadow-sm active:scale-95" title="Mover Contas">
