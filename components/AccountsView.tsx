    ...
    <div className="space-y-4 sm:space-y-5 animate-fade-in-up max-w-7xl mx-auto py-1 font-sans">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 px-2 sm:px-0">
            <div>
              ...
              <h1 className="text-3xl font-serif italic text-slate-900 dark:text-white tracking-tight">
                Minhas Contas<span className="text-gold">.</span>
              </h1>
            </div>
            <div className="flex items-center gap-2 w-full md:w-auto">
                <MonthPicker selectedDate={safeDate} onSelectDate={setSelectedDate} />
                <button onClick={onOpenMoveModal} className="p-2 rounded-xl bg-surface dark:bg-dark-surface border-2 border-border-color dark:border-dark-border-color text-slate-400 hover:text-gold transition-all shadow-sm active:scale-95" title="Mover Contas">
