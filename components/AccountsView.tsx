    ...
    >
        ...
        <div className="grid grid-cols-1 gap-4 pb-24 px-2 sm:px-0">
            <div className="space-y-4">
                ...
                <motion.div 
                    layout
                    className="bg-surface dark:bg-dark-surface rounded-2xl sm:rounded-[2rem] border-2 border-border-color dark:border-dark-border-color shadow-sm overflow-hidden"
                >
                        ...
                        <table className="w-full text-left border-collapse min-w-[800px]">
                            <thead>
                                <tr className="bg-surface-light dark:bg-dark-surface-light border-b-2 border-border-color dark:border-dark-border-color sticky top-0 z-10">
                                    ...
                                    <th className="p-4 text-[10px] font-black uppercase tracking-widest text-text-muted dark:text-dark-text-muted border-r border-border-color dark:border-dark-border-color w-40">Valor</th>
                                    <th className="p-4 text-[10px] font-black uppercase tracking-widest text-text-muted dark:text-dark-text-muted border-r border-border-color dark:border-dark-border-color w-40">Categoria</th>
                                    <th className="p-4 text-[10px] font-black uppercase tracking-widest text-text-muted dark:text-dark-text-muted border-r border-border-color dark:border-dark-border-color w-32">Vencimento</th>
                            ...
                            <tbody className="divide-y divide-border-color dark:divide-dark-border-color">
                                <AnimatePresence mode="popLayout">
                                    {currentMonthAccounts.map((acc, index) => {
                                        ...
                                        return (
                                            <motion.tr 
                                                ...
                                                animate={{ opacity: 1 }}
                                                exit={{ opacity: 0 }}
                                                className={`group transition-colors hover:bg-primary/10 dark:hover:bg-primary/20 ${index % 2 === 0 ? 'bg-surface dark:bg-dark-surface' : 'bg-surface-light/30 dark:bg-dark-surface-light/30'} ${isPaid ? 'bg-success/5 dark:bg-success/10' : ''}`}
                                            >
                                                ...
                                                <td className="p-3 border-r border-border-color dark:border-dark-border-color font-mono font-black text-sm tracking-tighter">
                                                ...
                                                <td className="p-3 border-r border-border-color dark:border-dark-border-color text-[10px] font-medium text-text-muted dark:text-dark-text-muted">
                                                    {acc.paymentDate ? new Date(acc.paymentDate).toLocaleDateString('pt-BR') : 'N/A'}
                                                </td>
