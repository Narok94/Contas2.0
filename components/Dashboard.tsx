            ...
            {activeTab === 'summary' && (
                ...
                >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                        {[
                            { label: 'Entradas', value: stats.totalIncome, icon: <TrendingUp className="w-5 h-5" />, color: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-900/20', gradient: 'from-emerald-500/10 to-transparent' },
                            { label: 'Saídas Pagas', value: stats.paid, icon: <TrendingDown className="w-5 h-5" />, color: 'text-rose-500', bg: 'bg-rose-50 dark:bg-rose-900/20', gradient: 'from-rose-500/10 to-transparent' },
                            { label: 'Pendentes (Mês)', value: stats.pending, icon: <Calendar className="w-5 h-5" />, color: 'text-amber-500', bg: 'bg-amber-50 dark:bg-amber-900/20', gradient: 'from-amber-500/10 to-transparent' },
                ...
                >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div className="h-[400px] w-full bg-surface-light dark:bg-dark-surface-light p-6 rounded-[2.5rem] border border-border-color/50 dark:border-dark-border-color/50">
                            <h4 className="text-xs font-black uppercase tracking-widest text-slate-400 mb-6">Fluxo de Caixa (Entradas vs Saídas)</h4>
                            <ResponsiveContainer width="100%" height="100%">
                        ...
                        <div className="h-[400px] w-full bg-surface-light dark:bg-dark-surface-light p-6 rounded-[2.5rem] border border-border-color/50 dark:border-dark-border-color/50">
                            <h4 className="text-xs font-black uppercase tracking-widest text-slate-400 mb-6">Evolução Mensal de Despesas</h4>
                            <ResponsiveContainer width="100%" height="100%">
