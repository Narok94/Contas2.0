...
const AccountCard: React.FC<AccountCardProps> = ({ account, onEdit, onDelete, onToggleStatus, onNotifyWhatsApp, whatsappEnabled }) => {
  ...
  return (
    ...
    >
        ...
        <div className="mt-2 pt-2 border-t border-border-color dark:border-dark-border-color flex flex-col gap-2">
            ...
            {isPaid && whatsappEnabled && (
                <button 
                    ...
                    className="w-full py-1.5 sm:py-2 rounded-xl flex items-center justify-center gap-2 transition-all flex-shrink-0 border-2 border-success text-success dark:text-dark-text-primary font-black text-[8px] sm:text-[10px] uppercase tracking-widest hover:bg-success hover:text-white active:scale-95"
                >
