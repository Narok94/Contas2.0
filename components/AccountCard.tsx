      ...
      >
        ...
        <div className="flex items-center gap-2 mt-2 pt-2 border-t border-border-color/50 dark:border-dark-border-color/50">
          ...
          <button 
            ...
            title="Editar" 
            className="p-2 rounded-lg bg-gray-100 dark:bg-dark-surface-light text-text-secondary dark:text-dark-text-secondary hover:bg-primary/10 hover:text-primary transition-colors"
          >
           ...
           <button 
            ...
            title="Excluir" 
            className="p-2 rounded-lg bg-gray-100 dark:bg-dark-surface-light text-text-secondary dark:text-dark-text-secondary hover:bg-danger/10 hover:text-danger transition-colors"
          >
