        ...
        <div className="mt-2 pt-2 border-t border-slate-200 dark:border-slate-700 flex flex-col gap-2">
            ...
            {isPaid && whatsappEnabled && (
                <button 
                    ...
                    className="w-full py-1.5 sm:py-2 rounded-lg flex items-center justify-center gap-2 transition-all flex-shrink-0 border-2 border-emerald-500 text-emerald-600 dark:text-emerald-400 font-black text-[8px] sm:text-[10px] uppercase tracking-widest hover:bg-emerald-500 hover:text-white active:scale-95"
                >
