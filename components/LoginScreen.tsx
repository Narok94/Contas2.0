...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[length:200%_200%] bg-gradient-to-br from-slate-100 via-sky-100 to-slate-200 dark:from-slate-900 dark:via-secondary-dark dark:to-slate-800 animate-gradient-pan relative overflow-hidden p-4">
        {/* Decorative Blobs */}
        ...
        <div className="w-full max-w-sm p-6 space-y-6 bg-white/60 dark:bg-dark-background/60 backdrop-blur-2xl rounded-3xl shadow-2xl ring-1 ring-black/5 z-10">
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-sm text-text-secondary dark:text-dark-text-secondary">Bem-vindo de volta!</p>
            </div>
