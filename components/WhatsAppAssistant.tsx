    ...
    const welcomeMsgs: Message[] = [
      {
        id: 'welcome-1',
        sender: 'bot',
        text: `Olá, Jéssica! Sou o seu assistente financeiro pessoal do Tatu. 🦦\n\nEstou aqui para facilitar o controle de suas contas. Você pode digitar o que comprou, pagou ou recebeu, e eu cuido do resto para você!`,
      ...
      },
      {
        id: 'welcome-2',
        sender: 'bot',
        text: `Experimente digitar:\n📝 *"Comprei lanche de 35 reais"*\n📝 *"Paguei 120 de luz"*\n📝 *"Recebi 1500 de bônus"*\n\nOu peça um resumo do mês digitando:\n📊 *"Resumo das contas"*`,
        timestamp: formatTime(new Date()),
        isRead: true
      }
    ];
